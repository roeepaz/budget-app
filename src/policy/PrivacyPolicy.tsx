  ...
  return (
    <div className="max-w-3xl mx-auto p-6 text-right">
      ...
      <ul className="list-disc pr-5 space-y-2">
        ...
        <li>
          <strong>מטרת השימוש:</strong> גישה לחשבון, שמירה בענן, שיפור חוויית המשתמש.
        </li>
        <li>
          <strong>אבטחה:</strong> שמירת מידע בפיירבייס, גישה מוצפנת, גישה אדמיניסטרטיבית מוגבלת.
        </li>
        <li>
          <strong>צד שלישי:</strong> אין שיתוף מידע ללא הודעה והסכמה מראש.
        </li>
        <li>
