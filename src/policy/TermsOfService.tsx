  ...
  return (
    <div className="max-w-3xl mx-auto p-6 text-right">
      ...
      <ul className="list-disc pr-5 space-y-2">
        <li>
          השימוש באתר מהווה הסכמה לתנאים אלו. אין להשתמש בשירות ללא הסכמה.
        </li>
        <li>
          התחברות באמצעות Google בלבד.
        </li>
        <li>
          שימוש חוקי בלבד, אין להעלות מידע כוזב.
        </li>
        <li>
          אין התחייבות לדיוק או אחריות להחלטות פיננסיות.
        </li>
        <li>
